...
(begin-ffi
  ...
  (c-declare "#include <capstone/evm.h>")

  (c-define-type cs_evm "cs_evm")
  (c-define-type cs_evm* (pointer cs_evm))
  (define-c-lambda evm-pop (cs_evm*) unsigned-int8
    "___return (___arg1->pop);")
  (define-c-lambda evm-push (cs_evm*) unsigned-int8
    "___return (___arg1->push);")
  (define-c-lambda evm-fee (cs_evm*) unsigned-int
    "___return (___arg1->fee);")

  (defenum (evm_insn "evm_insn")
    EVM_INS_STOP
    EVM_INS_ADD
    EVM_INS_MUL
    EVM_INS_SUB
  ...
  (defenum (evm_insn_group "evm_insn_group")
    EVM_GRP_INVALID
    EVM_GRP_JUMP
    EVM_GRP_MATH
    EVM_GRP_STACK_WRITE
